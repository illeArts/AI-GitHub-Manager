...
## Erstellt dist/AI_GitHub_Manager_1.0.0_macOS_arm64.dmg — öffnen, App in Applications ziehen, fertig.
...
2. Erstellt dist\AI_GitHub_Manager_Setup_1.0.0_win-x64.exe mit Inno Setup
